    ...
    <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding: 30px;">
            ...
            <div class="row">
                  <label for="copy_passcode">Set Password</label>
            ...
            <div class="row" style="margin-top:10px;">
                 <label for="copy_paymentid">Set Payment</label>
                  <input type="text" name="copy_paymentid" id="copy_paymentid" class="form-control" placeholder="" aria-describedby="helpId">
                  </div>
