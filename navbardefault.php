...
<nav class="navbar navbar-expand-lg navbar navbar-dark bg-primary">
  <a class="navbar-brand" href="#">Iceberg Maritime Solution</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <?php
            ...
            {
      echo   '<li class="nav-item '. $active1 .'">
             <a class="nav-link" href="accessability2.php">Accounts <span class="sr-only">(current)</span></a>
              </li>';
      ...
      //         </li>';
              ...
              echo '<li class="nav-item '. $active2 .'">
                    <a class="nav-link" href="managequestions.php">Question Management</a>
                  </li>';  
